...
class dialogSell(Frame):
    ...
    def sell_drink(self):
        ...
        self.sex.sell(drink[selected], amount)
    ...
    def calc_price(self):
        ...
        if len(self.selection) > 0:
            ...
            return
        self.newprice = amount * self.drink[selected].sellprice_quartjes
        self.pricevar = "price: "+self.newprice
    ...
    def createWidgets(self):
        ...
        self.pricevar = "price: "
        self.l_price = Label(self, textvariable=self.pricevar, width = 20, height = 0, font = font16)
        self.l_price.grid(row = 2,column=1,sticky=EW, padx = 0, pady = 0)
